...
def novo_servico(Dados):
    ...
    canvas = tk.Canvas(janelanovoservico)
    scrollbar = ttk.Scrollbar(janelanovoservico, orient="vertical", command=canvas.yview)
    ...
    janelanovoservico.columnconfigure(0, weight=1)
    janelanovoservico.rowconfigure(0, weight=1) # Permite que o canvas se expanda
